    ...
    <head>
        ...
        <style>
            ...
            .profile-cover { background: linear-gradient(135deg, #111827 0%, #1f2937 100%); min-height: 180px; border-bottom-left-radius: 1rem; border-bottom-right-radius: 1rem; position: relative; }
            .profile-card { margin-top: -80px; border-radius: 1rem; }
            ...
            .card-hover:hover { transform: translateY(-4px); transition: .25s; box-shadow: 0 .75rem 1.5rem rgba(0,0,0,.1); }
                        ...
                        <div class="card border-0 shadow-sm card-hover">
                            <div class="card-body">
                                ...
                                <form class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="failNoti" checked>
                                            <label class="form-check-label" for="failNoti">Başarısız IP uyarıları</label>
                                        </div>
                                    </div>
    ...
    <!-- Cropper Modal (Yatay biraz geniş, karemsi) -->
